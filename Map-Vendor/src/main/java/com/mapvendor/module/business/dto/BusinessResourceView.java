...
public class BusinessResourceView {
    ...
    private final Integer sortNo; private final Boolean recommended; private final ResourceStatus status; private final LocalDateTime createdAt; private final LocalDateTime updatedAt;
    public BusinessResourceView(Long id, Long businessId, String name, Integer seatNum, String bedSpec, String description,
            Long imageResourceId, String imageUrl, Integer sortNo, Boolean recommended, ResourceStatus status, LocalDateTime createdAt, LocalDateTime updatedAt) {
        ...
        this.imageResourceId=imageResourceId;this.imageUrl=imageUrl;this.sortNo=sortNo;this.recommended=recommended;this.status=status;this.createdAt=createdAt;this.updatedAt=updatedAt;
    }
