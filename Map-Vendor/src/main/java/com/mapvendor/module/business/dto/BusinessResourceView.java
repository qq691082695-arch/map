...
public class BusinessResourceView {
    ...
    private final String bedSpec; private final String description; private final Long imageResourceId;
    ...
    public BusinessResourceView(Long id, Long businessId, String name, Integer seatNum, String bedSpec, String description,
            Long imageResourceId, Integer sortNo, ResourceStatus status, LocalDateTime createdAt, LocalDateTime updatedAt) {
        ...
        this.imageResourceId=imageResourceId;this.sortNo=sortNo;this.status=status;this.createdAt=createdAt;this.updatedAt=updatedAt;
    }
    ...
    public Long getImageResourceId(){return imageResourceId;} public Integer getSortNo(){return sortNo;} public ResourceStatus getStatus(){return status;}
