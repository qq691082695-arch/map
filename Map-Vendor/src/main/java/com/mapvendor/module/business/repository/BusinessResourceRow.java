...
public class BusinessResourceRow {
    private Long id,businessId,imageResourceId; private String name,bedSpec,description,imageUrl,status; private Integer seatNum,sortNo; private LocalDateTime createdAt,updatedAt;
