...
public class BusinessResourceService {
    ...
    private BusinessResourceView view(BusinessResourceRow r){return new BusinessResourceView(r.getId(),r.getBusinessId(),r.getName(),r.getSeatNum(),r.getBedSpec(),r.getDescription(),r.getImageResourceId(),r.getImageUrl(),r.getSortNo(),ResourceStatus.valueOf(r.getStatus()),r.getCreatedAt(),r.getUpdatedAt());}
