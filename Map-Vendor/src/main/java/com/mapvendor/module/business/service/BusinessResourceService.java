...
public class BusinessResourceService {
    ...
    private BusinessResourceRow dish(long b,DishSaveRequest r){BusinessResourceRow x=base(b,r.getName(),r.getDescription(),r.getImageResourceId());x.setSortNo(r.getSortNo());x.setRecommended(r.getRecommended());return x;}
    ...
    private BusinessResourceView view(BusinessResourceRow r){return new BusinessResourceView(r.getId(),r.getBusinessId(),r.getName(),r.getSeatNum(),r.getBedSpec(),r.getDescription(),r.getImageResourceId(),r.getImageUrl(),r.getSortNo(),r.getRecommended(),ResourceStatus.valueOf(r.getStatus()),r.getCreatedAt(),r.getUpdatedAt());}
